...
course.bookName = req.body.bookName;
course.bookISBN = req.body.bookISBN;
course.bookAuthor = req.body.bookAuthor;
course.bookPrice = req.body.bookPrice;
course.save((err, doc) => {
if (!err)
...
else { console.log('Failed to Delete Book Details: ' + err); }
});
});
